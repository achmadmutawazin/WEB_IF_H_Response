<?php
    ...
    $user_products_query="SELECT * FROM `inventory` ORDER BY `inventory`.`price` ASC";
...
<div>
            ...
            <br>
            <div class="container">
            <a href='signup.php' class="button" >+ Add</a>    
            <center>
                <table class="table">
                    <tbody>
                        <tr style="background-color:#210466;color:white;">
